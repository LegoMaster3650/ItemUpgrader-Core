...
public class HealUpgradeResult extends UpgradeResult {
	...
	public MutableComponent[] getTooltip(ItemStack stack) {
		return new MutableComponent[] {new TextComponent(ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(this.amount)), new TranslatableComponent(this.livingEntry.getDescriptionId())};
	}
