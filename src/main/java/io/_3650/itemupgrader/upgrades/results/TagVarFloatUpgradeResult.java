...
public class TagVarFloatUpgradeResult extends UpgradeResult {
	...
	public MutableComponent[] getTooltip(ItemStack stack) {
		return new MutableComponent[]{Component.literal(this.tagName), Component.literal(this.modifier.getName()), Component.literal(ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(this.value))};
	}
